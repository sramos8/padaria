  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      ...
      <button
        ...
        class="px-8 py-3 mt-10 text-2xl font-bold text-white rounded-full bg-brand-DarkOrange focus:outline-none transition-all duration-150"
      >
...
// import Icon from '../../assets/imagens/Icon'
